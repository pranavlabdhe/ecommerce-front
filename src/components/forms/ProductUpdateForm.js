...
const {Option} =Select 
const ProductUpdateForm = ({handleChange,handleSubmit,values,handleCategoryChange,showSub,subOptions,setValues,categories,ArrayOfSubIds,setArraysOfSubIds}) => {
    const {title,description,price,
        // categories,
        category,
        subs,shipping,quantity,images,colors,brands,color,brand} = values
  return (
    <>
                ...
                <div className='form-group'>
                  ...
                  <div>
                    ...
                    <Select
                        ...
                        value={ArrayOfSubIds}
                        onChange={((value)=>setArraysOfSubIds(value))}
                    >
